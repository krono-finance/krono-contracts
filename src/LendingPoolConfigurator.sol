...
contract LendingPoolConfigurator is VersionedInitializable, ILendingPoolConfigurator {
    ...
    function updateAToken(UpdateKTokenInput calldata input) external onlyPoolAdmin {
        ...
        _upgradeTokenImplementation(reserveData.kTokenAddress, input.implementation, encodedCall);

        emit KTokenUpgraded(input.asset, reserveData.kTokenAddress, input.implementation);
    }
